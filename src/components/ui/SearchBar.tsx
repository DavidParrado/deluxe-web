    ...
    <div className={`w-full flex items-center justify-center bg-transparent ${className}`}>
      <div className="flex w-full rounded bg-white">
        ...
        <button type="submit" className="rounded rounded-l-none bg-slate-900 px-3 py-2 text-white">
          <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 56.966 56.966" xmlSpace="preserve" width="512px" height="512px">
